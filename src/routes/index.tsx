...
const OG_IMAGE = `https://theroyeffect.com${ogImageAsset.url}`;
...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      { rel: "canonical", href: "https://theroyeffect.com/" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://theroyeffect.com/brand/roy-effect-emblem.webp",
