...
export function ClosingMarqueeCta() {
  ...
  return (
    <section className="relative z-20 isolate overflow-hidden border-t border-white/10 bg-[#030014] px-5 py-24 md:px-10 md:py-32">
      ...
      >
        <div
          className={`flex w-max shrink-0 whitespace-nowrap font-display text-[22vw] uppercase leading-none text-white/[0.05] md:text-[16vw] ${animate ? "animate-cta-marquee" : ""}`}
        >
          <span>{PHRASE}</span>
          <span>{PHRASE}</span>
        </div>
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <p className="mt-6 max-w-2xl font-mono text-base leading-[1.6] text-white/90">
          One call. Your goal, your timeline, your budget — and a straight answer on whether
          I&apos;m the right fit.
        </p>
        <Button
          asChild
        ...
        <Link
          to="/book"
          className="mt-3 inline-flex min-h-11 items-center py-2 font-mono text-[15px] text-white/90 underline decoration-[#DFBA73] underline-offset-4 hover:text-[#DFBA73]"
        >
