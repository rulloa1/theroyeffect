        ...
        {viewMode === "ESTIMATOR" ? (
          ...
          <>
            ...
            {mode === "homepage" ? (
              <Link
                to="/pricing"
                className="mt-5 inline-flex min-h-11 items-center py-2 font-mono text-[15px] tracking-widest text-[#DFBA73] hover:text-white"
              >
                SEE FULL PRICING AND CHECKOUT →
              </Link>
            ) : null}
          </>
        )}
